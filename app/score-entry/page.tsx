          ...
          {recentScores.length > 0 ? (
            <div className="space-y-4">
              {recentScores.map((score) => {
                ...
                const leader = leaderByGame[score.gameId]
                const leaderDisplayName = leader?.username === user.username ? 'You' : leader?.username
                return (
                  <div key={score.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-lg gap-4">
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                      ...
                      <div className="text-right pr-4 border-r border-gray-200">
                        <div className="text-xs text-gray-500 mb-0.5">Highest</div>
                        <div className="text-2xl font-bold text-primary">{score.score.toLocaleString()}</div>
                      </div>
                      <div className="text-right">
                        <div className="text-xs text-gray-500 mb-0.5">Recent</div>
